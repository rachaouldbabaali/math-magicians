...
```sh
  cd my-folder
  git clone https://github.com/rachaouldbabaali/math-magicians/tree/main
```
...
Feel free to check the [issues page](https://github.com/rachaouldbabaali/math-magicians/issues).
...
This project is [MIT](https://github.com/rachaouldbabaali/math-magicians/blob/main/LICENSE) licensed.
